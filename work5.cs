    ...
    public partial class work5 : Form
    {
        ...
        void calcu()     //統一運算  總分  平均  最低   最高
        {
            ...
            for (int i = 0; i < 3; i++)                     //目前為算單人 總分 平均  最低  最高
            {
                ...
                {
                    if (para.max < para.score[para.stu_num, i]) {       //找出最大
                    ...
                    if (para.min > para.score[para.stu_num, i]) {       //找出最小
            ...
            int str_count = 0;                              //用以紀錄該放在哪一行
            bool flag_mi = false , flag_ma = false;         //判斷是否是第一次放入
        ...
        private void button1_Click(object sender, EventArgs e)      //插入字串所加入的新值
        {
            ...
            if(num1 && num2 && num3 && !str) { 
                ...
                //textBox5.Text += $"\r\n{textBox1.Text,-7}{textBox2.Text,10}{textBox3.Text,8}{textBox4.Text,8}" +
                //    $"{para.sum,8}{para.avg,8}{para.min,8}{para.max,8}{" ",-5}";
